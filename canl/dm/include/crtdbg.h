...
#define _strdup_dbg(s,t,f,l)            strdup(s)
#define __strdup_dbg(s,t,f,l)           _strdup(s)
#define __wcsdup_dbg(s,t,f,l)           _wcsdup(s)
#define unmangle_pt_dbg(s,t,f,l)        unmangle_pt(s)
#define unmangle_ident_dbg(s,t,f,l)     unmangle_ident(s)
...
#define   _strdup(s)            __strdup_dbg(s,_NORMAL_BLOCK,__FILE__, __LINE__)
#define   strdup(s)             _strdup_dbg(s,_NORMAL_BLOCK,__FILE__,__LINE__)
#define   _wcsdup(s)            __wcsdup_dbg(s,_NORMAL_BLOCK,__FILE__,__LINE__)
#define   handle_malloc(s)  	_malloc_dbg(s, _NORMAL_BLOCK, __FILE__, __LINE__)
#define   handle_calloc(c)      _calloc_dbg((c), 1, _NORMAL_BLOCK, __FILE__, __LINE__)
#define   handle_realloc(p,s)   _realloc_dbg((p), (s), _NORMAL_BLOCK, __FILE__, __LINE__)
#define   handle_free(p)	    _free_dbg(p, _NORMAL_BLOCK)
#define   handle_strdup(s)    	_strdup_dbg(s,_NORMAL_BLOCK,__FILE__,__LINE__)
#define   unmangle_pt(s)        unmangle_pt_dbg(s,_NORMAL_BLOCK,__FILE__,__LINE__)
#define   unmangle_ident(s)     unmangle_ident_dbg(s,_NORMAL_BLOCK,__FILE__,__LINE__)
#define   __UNMANGLE_DEFINED   1
...
_CRTIMP char * __cdecl _strdup_dbg(
        const char *,
        int,
        const char *,
        int
...
_CRTIMP char * __cdecl __strdup_dbg(
        const char *,
        int,
        const char *,
        int
...
_CRTIMP wchar_t * __cdecl __wcsdup_dbg(
        const wchar_t *,
        int,
        const char *,
        int
...
_CRTIMP char * __cdecl unmangle_pt_dbg(
        const char **,
        int,
        const char *,
        int
...
_CRTIMP char * __cdecl unmangle_ident_dbg(
        const char *,
        int,
        const char *,
        int
